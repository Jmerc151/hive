...
- **Spend limits raised** — daily $8→$20, monthly $200→$500, per-agent limits 2-3x higher
- **ReAct steps doubled** — 8→15 steps per task for deeper, more thorough agent work
- **Auto-chain tripled** — 5→15 auto-tasks/day, queue cap 3→8 per agent
- **Smarter model downgrade** — uses per-agent limits when set, triggers at 90% instead of 80%
