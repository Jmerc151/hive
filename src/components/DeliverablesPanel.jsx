...
export default function DeliverablesPanel({ agents = [], onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-page backdrop-blur-sm z-50 flex justify-center items-start pt-8 pb-8 overflow-y-auto" onClick={onClose}>
      <div className="w-full max-w-4xl bg-s1 rounded-2xl shadow-2xl flex flex-col max-h-[90vh]" style={{ border: '0.5px solid rgba(0,0,0,0.08)' }} onClick={e => e.stopPropagation()}>
        {/* Header */}
